<?php
	...
	function verpedidosnoefect($nomusuari)
	{
    ...
    //        echo "Comanda:".$sql;select pedido.ID_Pedido as NumPedido,despegable_seguiment.Descripcio as EstatDescripcio from pedido inner join despegable_seguiment on pedido.Estat=despegable_seguiment.ID_Estat inner join usuari on pedido.ID_Usuari=usuari.ID_Usuari where usuari.Nom_Usuari='Ignasi8310' and pedido.Estat!=4
