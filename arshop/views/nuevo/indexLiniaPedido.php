...
<head>
    ...
    <title>Crear Linia Pedido</title>
</head>
    <style>
        .estru
        {
...
<body style="background-color: dark">
    ...
    <br>
        ...
        <h1 class="center">Nova Linia Pedido</h1>
    
        <div id= "main" class="d-flex justify-content-center form_container">

            <div class="center"><?php echo $this->mensaje;?></div>

            <form action="<?php echo  constant('URL');?>/nuevo/registro_liniapedido" method="post" enctype="multipart/form-data">
            ...
            <label for="ID_Producte" class="estru">Producte:
                    ...
                    <input type="number" class="form-control" placeholder="Entra la Quantitat" name="Quantitat" required></label>
                    
                        
                <br></br>
                  
                <div class="estru"><input  type="submit" class="btn btn-primary" value="Crear Nova Linia de Pedido"></div>
            </form>
        </div>
