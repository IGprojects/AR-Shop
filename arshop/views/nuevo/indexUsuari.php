...
<body>
    ...
    <br>
        ...
        <h1 class="center">Nou Usuari</h1>

        <div id="main" class="d-flex justify-content-center form_container">

            <div class="center"><?php echo $this->mensaje;?></div>

            <form action="<?php echo  constant('URL');?>/nuevo/registro_usuari" method="post" enctype="multipart/form-data">
                    ...
                    <input type="number" class="form-control" placeholder="Entra les Moneda" name="Moneda"  required></label>   
                        
                    <br>
                <div class="estru" style="align-items: center;"><input  type="submit" class="btn btn-primary" value="Crear Nou Usuari"></div>
            </form>
        </div>
